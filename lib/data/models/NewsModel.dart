...
class NewsModel {
  String? id, userId, newsId, categoryId, title, date, contentType, contentValue, image, desc, categoryName, counter, dateSent, totalLikes, like;
  ...
  factory NewsModel.fromVideos(Map<String, dynamic> json) {
    return NewsModel(
        id: json[ID].toString(),
        newsId: json[ID].toString(), //for bookmark get/set
        date: json[DATE],
        image: json[IMAGE],
        title: json[TITLE],
  ...
  factory NewsModel.fromJson(Map<String, dynamic> json) {
    ...
    return NewsModel(
        ...
        newsId: (json[NEWS_ID] != null && json[NEWS_ID].toString().trim().isNotEmpty) ? json[NEWS_ID].toString() : json[ID].toString(), //incase of null newsId in Response
