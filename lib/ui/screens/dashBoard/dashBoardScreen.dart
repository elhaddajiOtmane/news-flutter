    ...
    FirebaseDynamicLinks.instance.onLink.listen((dynamicLink) {
      ...
      if (deepLink.queryParameters.isNotEmpty) {
        ...
        if (isBreakingNews == "true") {
          context.read<BreakingNewsCubit>().getBreakingNews(langId: context.read<AppLocalizationCubit>().state.id).then((value) {
            if (value.isNotEmpty) {
          ...
          context.read<NewsByIdCubit>().getNewsById(newsId: id, langId: context.read<AppLocalizationCubit>().state.id).then((value) {
            if (value.isNotEmpty) {
              if (isVideoID == 'true') {
