...
const String deepLinkUrlPrefix = 'your_link'; //example - https://xxx.page.link only - Your dynamic link from Firebase
const String deeplinkURL = 'your_deeplink_url';//example - xxx.com - Your domain name
